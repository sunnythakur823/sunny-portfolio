  ...
  return (
    <div className="flex flex-col gap-7 lg:max-w-2xl">
      <div className="flex flex-col gap-4">
        <p className="hero-fade-up text-caption font-medium tracking-[0.24em] text-muted-foreground">
          SOFTWARE DEVELOPER
        </p>

        <div className="hero-lift flex flex-col gap-2">
          <Heading level={1} className="text-display max-w-[10ch] text-balance">
            SUNNY
            <br />
            KUMAR
          </Heading>
        ...
        <p className="hero-fade-up-delay-2 max-w-xl text-body text-foreground/85 text-pretty sm:text-lg">
          BCA student and aspiring software developer focused on full-stack development, AI, and cloud technologies.
        </p>
      </div>
      ...
      <div className="hero-fade-up-delay-4 flex flex-wrap items-center gap-3">
        ...
        <span className="text-small text-muted-foreground">
          Full-stack, AI, cloud, and product-minded engineering.
        </span>
      </div>
    </div>
  );
